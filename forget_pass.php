...
if(isset($_POST['submit'])) {
	$unmae = $_POST['user_name'];
	$query = "SELECT * FROM users WHERE user_name = '".$unmae."'";
...
<body  class="bg-secondary">
		<div class="container w-50 mt-5">
			<form class="bg-light p-5 shadow-lg" method="post">
				...
				<input type="user_name" name="user_name" placeholder="Email Address" class="form-control form-control-sm" required><br>
